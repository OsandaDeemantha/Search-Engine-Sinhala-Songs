...
class SongsScrape(scrapy.Spider):
    ...
    genre_name_translator = Translator()
    ...
    def details_extractor(self, response):
        ...
        self.genre_name=" , ".join(["" if genre == 'Unknown' else self.genre_name_translator.translate(genre,src='en', dest='si').text for genre in response.xpath('/html/body/div[1]/div[1]/div/main/article/div[3]/div[1]/div[2]/div/div/ul/li[2]/span/a/text()').getall()]).strip()
        ...
        if (self.song_name=="" or self.artist_name=="" or self.genre_name=="" or self.lyrics_by_name=="" or self.music_by_name=="" or self.lyrics==""):
            return
